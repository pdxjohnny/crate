...
class ArrayDifferenceFunction extends Scalar<Object[], Object> {
    ...
    private static class Resolver implements FunctionResolver {
        ...
        private static final FuncParams.ParamType arrayType = FuncParams.ParamType.of().matchBaseType(ArrayType.class);

        private static final FuncParams FUNC_PARAMS = FuncParams.of(arrayType, arrayType);
