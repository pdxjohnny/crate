...
public class DistanceFunction extends Scalar<Double, Object> {
    ...
    private static final FuncParams.ParamType ALLOWED_PARAM = FuncParams.ParamType.of(
    ...
    public static void register(ScalarFunctionModule module) {
        module.register(NAME, new BaseFunctionResolver(FuncParams.of(ALLOWED_PARAM, ALLOWED_PARAM)) {
            @Override
